...
/**
 * InvalidOperationParamException
 *
 * @author Manuel Núñez  (alex.alsina@mango.com)
 */
public class InvalidOperationParamException extends AbstractConnectorException {

    /**
     * Instantiates a new Invalid operation param exception.
     *
     * @param msg
     *     the message
     */
    public InvalidOperationParamException(final String msg) {
        super(msg);
    }
     ...
     *     wrapped Throwable
     */
    public InvalidOperationParamException(final Throwable cause) {
     ...
     *     wrapped Throwable
     */
    public InvalidOperationParamException(final String msg, @Nullable final Throwable cause) {
        super(msg, cause);
    }
