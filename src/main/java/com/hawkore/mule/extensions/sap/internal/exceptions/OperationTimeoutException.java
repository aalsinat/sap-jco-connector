 ...
 */
public class OperationTimeoutException extends AbstractConnectorException {
     ...
     *     the message
     */
    public OperationTimeoutException(final String msg) {
        super(msg);
    }
     ...
     *     wrapped Throwable
     */
    public OperationTimeoutException(final String msg, @Nullable final Throwable cause) {
        super(msg, cause);
    }
