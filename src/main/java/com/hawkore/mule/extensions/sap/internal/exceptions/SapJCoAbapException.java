 ...
 */
public class SapJCoAbapException extends AbstractConnectorException {
     ...
     *     the message
     */
    public SapJCoAbapException(final String msg) {
        super(msg);
    }
     ...
     *     wrapped Throwable
     */
    public SapJCoAbapException(final Throwable cause) {
     ...
     *     wrapped Throwable
     */
    public SapJCoAbapException(final String msg, @Nullable final Throwable cause) {
        super(msg, cause);
    }
