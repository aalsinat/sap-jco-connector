 ...
 */
public class OperationExecutionException extends AbstractConnectorException {

    /**
     * Instantiates a new Operation execution exception.
     *
     * @param msg
     *     the message
     */
    public OperationExecutionException(final String msg) {
        super(msg);
    }
     ...
     *     wrapped Throwable
     */
    public OperationExecutionException(final String msg, @Nullable final Throwable cause) {
        super(msg, cause);
    }
