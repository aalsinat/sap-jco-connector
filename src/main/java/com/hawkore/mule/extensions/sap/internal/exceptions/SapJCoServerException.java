...
/**
 * SapJCoServerException
 *
 * @author Manuel Núñez  (alex.alsina@mango.com)
 */
public class SapJCoServerException extends AbstractConnectorException {

    /**
     * Instantiates a new SapJCoServerException exception.
     *
     * @param msg
     *     the message
     */
    public SapJCoServerException(final String msg) {
        super(msg);
    }
     ...
     *     wrapped Throwable
     */
    public SapJCoServerException(final Throwable cause) {
     ...
     *     wrapped Throwable
     */
    public SapJCoServerException(final String msg, @Nullable final Throwable cause) {
        super(msg, cause);
    }
